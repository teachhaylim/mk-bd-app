...
class _MomentsScreenState extends State<MomentsScreen> with WidgetsBindingObserver {
        ...
        children: [
          ...
          Positioned(
            ...
            child: CardSwiper(
              ...
              cardsCount: MockData.moments.length,
              scale: 0.6,
              maxAngle: 50,
              ...
              child: Column(
                children: [
                  ValueListenableBuilder(
                    ...
                    builder: (_, value, __) {
                      final text = MockData.moments[value].text;
                  ...
                  ValueListenableBuilder(
                    ...
                    builder: (_, value, __) {
                      return Text(
                        "${value + 1}/${MockData.moments.length}",
                        style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w700, color: Colors.white),
                      );
                    },
                  ),
